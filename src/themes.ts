...
export const CARD_THEMES: CardTheme[] = [
  ...
  { id: 'sunset',        name: 'Sunset',        emoji: '\u{1F305}',    requiredWins: FLAGS.THEME_GATES_ENABLED ? 5  : 0, isPremium: FLAGS.THEME_GATES_ENABLED, skuId: 'theme_sunset',        confettiColors: ['#fb923c','#f97316','#fbbf24','#ef4444'], accentColor: '#fb923c', markedColorRgb: '251,146,60',  winColorRgb: '239,68,68',   oneAwayColorRgb: '251,146,60',  defaultTileBg: 'rgba(255,255,255,0.05)', defaultTileBorder: 'rgba(251,146,60,0.18)',  defaultTileText: '#fff7ed' },
  { id: 'ocean',         name: 'Ocean',         emoji: '\u{1F30A}',    requiredWins: FLAGS.THEME_GATES_ENABLED ? 10 : 0, isPremium: FLAGS.THEME_GATES_ENABLED, skuId: 'theme_ocean',         confettiColors: ['#38bdf8','#0ea5e9','#7dd3fc','#e0f2fe'], accentColor: '#38bdf8', markedColorRgb: '56,189,248',  winColorRgb: '14,165,233',  oneAwayColorRgb: '56,189,248',  defaultTileBg: 'rgba(255,255,255,0.05)', defaultTileBorder: 'rgba(56,189,248,0.18)',  defaultTileText: '#f0f9ff' },
  { id: 'midnight_rose', name: 'Midnight Rose', emoji: '\u{1F339}',    requiredWins: FLAGS.THEME_GATES_ENABLED ? 25 : 0, isPremium: FLAGS.THEME_GATES_ENABLED, skuId: 'theme_midnight_rose', confettiColors: ['#f472b6','#ec4899','#fbcfe8','#9d174d'], accentColor: '#f472b6', markedColorRgb: '244,114,182', winColorRgb: '236,72,153',  oneAwayColorRgb: '244,114,182', defaultTileBg: 'rgba(255,255,255,0.05)', defaultTileBorder: 'rgba(244,114,182,0.18)', defaultTileText: '#fdf2f8' },
  { id: 'arctic',        name: 'Arctic',        emoji: '\u2744\uFE0F', requiredWins: FLAGS.THEME_GATES_ENABLED ? 50 : 0, isPremium: FLAGS.THEME_GATES_ENABLED, skuId: 'theme_arctic',        confettiColors: ['#818cf8','#6366f1','#c7d2fe','#e0e7ff'], accentColor: '#818cf8', markedColorRgb: '129,140,248', winColorRgb: '99,102,241',  oneAwayColorRgb: '129,140,248', defaultTileBg: 'rgba(255,255,255,0.05)', defaultTileBorder: 'rgba(129,140,248,0.18)', defaultTileText: '#eef2ff' },
]
